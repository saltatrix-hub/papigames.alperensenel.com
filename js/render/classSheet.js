...
const GEAR = [0, 1, 3, 2]; // game dir (front, left, right, back) -> sheet order front, left, back, right
...
const PACKS = {
  ...
  Mage: {
    ...
    wscale: 0.58,
    hand: 0.22,
    cuts: [[19, 10, 169, 307], [189, 10, 157, 307], [527, 14, 165, 302], [357, 14, 161, 301]],
  ...
  Priest: {
    ...
    wscale: 0.55,
    hand: 0.22,
    cuts: [[19, 20, 174, 295], [194, 23, 154, 292], [522, 23, 155, 292], [353, 20, 170, 294]],
